...
// as in the C level the optval parameter is just a pointer
...
// Socket options (constants unchanged) ...
...
#define SOCKOPT_BYTES(OptionName,Macro,InitSize) \
   ...
   //--- for curve key (array length 32 bytes)
#define SOCKOPT_CURVE_KEY(KeyType,Macro) \
   ...
   // gssapi (unsupported in this binding)
...
//+------------------------------------------------------------------+
//| Get string option (uses uchar[] to match array overload)         |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| Set string option (uses uchar[] to match array overload)         |
//+------------------------------------------------------------------+
